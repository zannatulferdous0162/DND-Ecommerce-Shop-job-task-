        ...
        <div className="mt-10 flex flex-col items-center">
            <div className="grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 grid-cols-2 gap-10">
                <div className="flex justify-center items-center p-4 hover:scale-105 transition-transform">
                    <img src={logo1} alt="Client Logo 1" className="w-full max-w-[120px] object-contain" />
                </div>
                <div className="flex justify-center items-center p-4 hover:scale-105 transition-transform">
                    <img src={logo2} alt="Client Logo 2" className="w-full max-w-[120px] object-contain" />
                </div>
                <div className="flex justify-center items-center p-4 hover:scale-105 transition-transform">
                    <img src={logo3} alt="Client Logo 3" className="w-full max-w-[120px] object-contain" />
                </div>
                <div className="flex justify-center items-center p-4 hover:scale-105 transition-transform">
                    <img src={logo4} alt="Client Logo 4" className="w-full max-w-[120px] object-contain" />
                </div>
                <div className="flex justify-center items-center p-4 hover:scale-105 transition-transform">
                    <img src={logo5} alt="Client Logo 5" className="w-full max-w-[120px] object-contain" />
                </div>
            </div>
        </div>
    );
